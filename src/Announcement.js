    ...
    constructor(props) {
      ...
      componentWillMount(){
        ...
        this.setState({ ...this.state, messages: [] });
            ...
            let messagesRef = fire.database().ref('announcements').orderByKey().limitToLast(100);
      ...
      this.inputE3.value = ''; 
      this.inputE2.value = ''; 
      let messagesR = fire.database().ref('announcements').orderByKey().limitToLast(100);
      ...
      render() {
        return (
            ...
            <p id='oneline'> Pop-up and its Message </p>
      ...
      : (null)}
          ...
          <input className='gocenter' id='oneline' type="text" ref={ el => this.inputE3 = el } placeholder="Enter the pop-up message"/><br/>
              <input className='gocenter' id='textarea' type="text" ref={ e2 => this.inputE2 = e2 } placeholder="Enter the announcement"/><br/>
